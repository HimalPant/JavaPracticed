...
public class ViewForm extends JFrame {
	...
	private JButton getBtnBack() {
		if (btnBack == null) {
			...
			btnBack.setFont(new Font("Sitka Small", Font.PLAIN, 16));
			btnBack.setBackground(Color.GREEN);
			btnBack.setBounds(1003, 643, 109, 31);
		}
		return btnBack;
	}
}
